...
class HospedeControllerTest {
	...
	void testListarTodosHospedes() {
		// Arrange
		Hospede hospede1 = new Hospede(null, "Julia Maria", "julia@gmail.com", "(00)0000-000");
		Hospede hospede2 = new Hospede(null, "Julio Feranndo", "julia@gmail.com", "(00)000-000");
		...
		assertEquals(2, response.getBody().length, "A quantidade de hóspedes retronada deveria ser: 2.");
	}

	@Test
	@DisplayName("Teste de buscar Hóspedes por ID")
	...
	@Test
	@DisplayName("Teste a atualização de Hóspedes")
	void testAtualizarHospede() {
		Hospede hospedeSalvo = hospedeRepository
				.save(new Hospede(null, "Julia Maria", "julia@gmail.com", "(00)0000-0000"));
	...
	void testDeletarHospede() {
		...
		assertEquals(HttpStatus.NOT_FOUND, checkDeleted.getStatusCode(),"Após o DELETE o hospede não deveria ser encontrado.");
	}
}
